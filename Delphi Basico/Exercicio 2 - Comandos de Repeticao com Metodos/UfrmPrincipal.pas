...
// METODO FUNÇÃO PARA A OPÇÃO "FOR":
...
// METODO FUNÇÃO PARA A OPÇÃO "WHILE":
...
// METODO FUNÇÃO PARA A OPÇÃO "REPEAT":
...
begin
  ...
  case TComandos(rdgComandos.ItemIndex) of
    cmdFor:
        ShowMessage(IntToStr(Self.ComandFor)); //Chama Função FOR

    cmdWhile:
        ShowMessage(IntToStr(Self.ComandWhile)); //Chama função WHILE

    cmdRepeat:
        ShowMessage(IntToStr(Self.ComandRepeat)); //Chama Função REPEAT
  else
