...
begin
  ...
  mmListaProdutos.Lines.Add('A média do valor de custo dos produtos foi de R$'+
                            FormatFloat('#0.##', xCustoMedio) );
  mmListaProdutos.Lines.Add('A média do valor de venda dos produtos foi de R$'+
