...
begin
  ...
  mmListaAptos.Lines.Add('lista de aptos para o serviço militar:');
  mmListaNaoAptos.Lines.Add('lista de Não aptos para o serviço militar:');
  ...
  repeat
    ...
    xSaude := inputbox( 'Alistamento Militar','Saúde: 1(Boa) ou 2(Ruim)','');
